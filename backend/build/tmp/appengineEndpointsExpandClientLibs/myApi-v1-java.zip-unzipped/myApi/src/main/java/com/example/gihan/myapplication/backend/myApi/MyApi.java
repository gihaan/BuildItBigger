 ...
 * on 2017-10-17 at 05:10:27 UTC 
 * Modify at your own risk.
 */

package com.example.gihan.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   *
   * @param content the {@link com.example.gihan.myapplication.backend.myApi.model.MyBean}
   * @return the request
   */
  public SayHi sayHi(com.example.gihan.myapplication.backend.myApi.model.MyBean content) throws java.io.IOException {
    SayHi result = new SayHi(content);
    initialize(result);
    return result;
  }

  public class SayHi extends MyApiRequest<com.example.gihan.myapplication.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SayHi(com.example.gihan.myapplication.backend.myApi.model.MyBean content) {
      super(MyApi.this, "POST", REST_PATH, content, com.example.gihan.myapplication.backend.myApi.model.MyBean.class);
    }
