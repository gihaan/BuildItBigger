...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://builditbigger-78280.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<com.example.gihan.myapplication.backend.myApi.model.MyBean> {
     ...
     */
    protected SayHi() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.gihan.myapplication.backend.myApi.model.MyBean.class);
    }
